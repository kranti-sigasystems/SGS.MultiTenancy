...
namespace SGS.MultiTenancy.Core.Services.ServiceInterface
{
    ...
    public interface IPermissionService
    {
        ...
        public Task<PermissionResponseDto> GetPermissionsAsync();
        ...
        /// A response containing the permission if found.
        /// </returns>
        Task<PermissionResponseDto> GetPermissionByCodeAsync(string code);
        ...
        /// </returns>
        Task<PermissionResponseDto> GetPagedPermissionsAsync(int page, int pageSize);
        ...
        /// </returns>
        Task<PermissionResponseDto> AddPermissionAsync(
        ...
        /// </returns>
        Task<PermissionResponseDto> UpdatePermissionAsync(
            Guid id,
            PermissionRequestDto request);
        ...
        /// </returns>
        Task<PermissionResponseDto> DeletePermissionAsync(Guid id);
    }
}